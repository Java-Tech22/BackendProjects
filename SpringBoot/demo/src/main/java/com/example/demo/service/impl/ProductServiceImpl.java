...
public class ProductServiceImpl  implements ProductService{
	...
	public Product saveProduct(Product product) {
		...
		c.setFirstName(response.getFirstName());
		c.setLastName(response.getLastName());
		c.setProduct(response.getProduct());
		c.setId(response.getId());
		c.setAddressId(response.getAddressResponse().getAddressId());
		if(c!=null) {
