...
public class CustomerServiceTest {
	 ...
	 @InjectMocks
	    ...
	    public void CustomerService_findAllCustomer_success(){
			...
			customer1.setProduct(Stream.of( new Product(1, "TV", "Smart TV", null, null, 0, customer1)).collect(Collectors.toList()));
			Customer customer2 = new Customer();
			customer2.setId(2);
			customer2.setFirstName("Megha");
			customer2.setLastName("Dev");
			customer2.setProduct(Stream.of( new Product(1, "Phone", "Smart Phone", null, null, 0, customer2)).collect(Collectors.toList()));
